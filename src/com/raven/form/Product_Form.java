...
//        lbPrice.setText(df.format(data.getPrice()));
    ...
    private boolean isValidate() {
        ...
        if (txtGia.getText().equals("")) {
            Notification panel = new Notification(Employee_Form.fr, Notification.Type.WARNING, Notification.Location.TOP_CENTER, "Price isn't null");
            panel.showNotification();
            return false;
        }
        ...
        if(txtAnh.getText().equals("")) {
            Notification panel = new Notification(Employee_Form.fr, Notification.Type.WARNING, Notification.Location.TOP_CENTER, "Image is null");
                panel.showNotification();
                return false;
        }
        return true;
    ...
    private void insert() {
        ...
        try {
            ...
            load();
            clear();
            Notification panel = new Notification(Employee_Form.fr, Notification.Type.SUCCESS, Notification.Location.TOP_CENTER, "Add successful");
            panel.showNotification();
        } catch (Exception e) {
            Notification panel = new Notification(Employee_Form.fr, Notification.Type.WARNING, Notification.Location.TOP_CENTER, "Trung ID");
            panel.showNotification();
        }
    }
    ...
    private void update() {
        ...
        try {
            ...
            load();
            clear();
            Notification panel = new Notification(Employee_Form.fr, Notification.Type.SUCCESS, Notification.Location.TOP_CENTER, "Update successful");
            panel.showNotification();
        } catch (Exception e) {
        ...
        if (!Auth.isManager()) {
            ...
            if (XDialog.confirm(this, "Are you sure to delete")) {
                ...
                try {
                    ...
                    load();
                    clear();
                    Notification panel = new Notification(Employee_Form.fr, Notification.Type.SUCCESS, Notification.Location.TOP_CENTER, "Delete successful");
                    panel.showNotification();
                } catch (Exception e) {
